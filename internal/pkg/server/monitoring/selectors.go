...
type SelectorMap map[string]*grpc_inventory_manager_go.AssetSelector
...
func (s SelectorMap) AddAsset(asset *grpc_inventory_go.Asset) {
	...
	if found {
		...
		s[ecId] = &grpc_inventory_manager_go.AssetSelector{
...
// should be called
type selectorFunc func(*grpc_inventory_manager_go.AssetSelector) (SelectorMap, derrors.Error)
